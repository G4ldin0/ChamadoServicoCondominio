                            ...
                            <c:forEach var="worker" items="${workerList}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form style="display: inline;" method="POST" action="${pageContext.request.contextPath}/admin/colaboradores/apagar/${worker.id}" onsubmit="return confirm('Tem certeza que deseja deletar este colaborador?');">
