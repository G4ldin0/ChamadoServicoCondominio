...
<body>
    <div class="page-container">
        ...
        <div class="container">
            ...
            <form class="create-form" method="POST" action="${pageContext.request.contextPath}/admin/administradores">
            ...
            <c:choose>
                <c:when test="${empty adminList}">
                    <div class="empty-message">Nenhum administrador cadastrado no sistema.</div>
                </c:when>
                <c:otherwise>
